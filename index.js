function createImage(i)
     {
       ...
       // var div1=document.getElementById("din");
    // div1.id="div1";
  ...
  background-size: cover;`;
    ...
    //    button1.style.visibility="visible";
     ...
     div2.onmouseover=(event)=>
     {
        ...
        //  if( event.path[0].id=="div1-div2")
        // {
        //     event.path[0].children[1].style.visibility="visible";
        //  event.path[0].children[0].style.visibility="visible";
        // }
        //  if(event.path[0].id=="b")
        //  {
        //      console.log("b----"+event)
        //      console.log(event)
        //      event.path[1].children[0].style.visibility="visible";
        //      event.path[1].children[1].style.visibility="visible";
        //  }
        //  if(event.path[0].id+"".match("b1"))
        //  {
        //     event.path[1].children[0].style.visibility="visible";
        //      event.path[1].children[1].style.visibility="visible";
        //  }
     ...
     div4.onmouseout=(event)=>
     {
        event.path[1].children[0].children[1].style.visibility="hidden";
         event.path[1].children[0].children[0].style.visibility="hidden";
        // div1.style="background-color:white"
     }
    
     div2.onmouseout=(event)=>
     {
        // console.log(event.path);
         if(event.path[0].id=="div1-div2")
         {
       // event.path[0].children[1].style.visibility="hidden";
         //event.path[0].children[0].style.visibility="hidden";
         //console.log(event.path);
         }
        ...
        event.path[0].children[1].style.visibility="hidden";
         ...
         if(event.path[0].id=="b")
         {
             console.log("b----"+event)
             console.log(event)
             event.path[1].children[0].style.visibility="hidden";
             event.path[1].children[1].style.visibility="hidden";
         }
         if(event.path[0].id+"".match("b1"))
         {
            event.path[1].children[0].style.visibility="hidden";
       ...
       {
           var imj=document.getElementById("sq");
           var bounds=imj.getBoundingClientRect();
           var left=bounds.left;
    var top=bounds.top;
    var x = event.pageX - left;
    var y = event.pageY - top;
    var cw=imj.clientWidth
    var ch=imj.clientHeight
    var iw=imj.naturalWidth
    var ih=imj.naturalHeight
    var px=x/cw*iw
    var py=y/ch*ih
    if(x-90>=0&&x-90<=20&&y-90>=0&&y-90<=20)
           console.log(x+" "+y)
           else
           {
               console.log(x+" "+y+"pppp")
           }
       }
